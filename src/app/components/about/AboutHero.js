...
function AboutHero({ scrollY = 0 }) {
  ...
  return (
    <div className="w-full bg-white border-b border-dashed border-foreground relative overflow-hidden transition-opacity duration-1000 ease-in-out px-12 md:px-0">
      <div className="w-full max-w-[1200px] mx-auto md:mt-48 md:mb-4 mt-20 mb-8 ">
      ...
      <div className="w-full max-w-[800px] mx-auto flex md:flex-row flex-col gap-12 md:mt-24">
        <img src={getImageUrl(window.innerWidth < 768 ? "/about/about-mission-m.png" : "/about/about-mission.png")} 
        alt="The Mission" className="mx-auto " />
      </div>
      <div className="w-full max-w-[800px] mx-auto md:px-0 px-6 flex md:flex-row flex-col gap-12 mb-36 mt-16">
      ...
      <img
        ...
        className={`absolute md:w-[15%] md:top-[-20%] md:right-0 right-0 top-[-35%] w-[50%] transition-opacity duration-1000 ease-in-out}`}
        style={{
      ...
      <img
        ...
        alt="Background pattern"
        className={`absolute md:w-[15%] md:bottom-[-40%] bottom-[-35%] left-0 w-[50%] transition-opacity duration-1000 ease-in-out}`}
        style={{
