...
function EachMember() {
  ...
  return (
    <div className="md:max-w-[1150px] md:mt-12 mt-[-50px] mb-12 md:mb-24 ml-20 mr-12 md:mx-auto flex md:flex-row flex-col md:gap-24 gap-4" >
      ...
      gap-2 md:font-nunito md:font-normal font-bold font-thabit leading-[21px] md:leading-[26px] list-disc text-darkblue pt-4">
