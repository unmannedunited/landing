...
function WhoWeAre({ scrollY = 0 }) {
  ...
  return (
    <div className="md:max-w-[1200px] mx-20 md:mx-auto" 
      ...
      boxShadow: '18px 20px 26px -7px rgba(0, 0, 0, 0.25)' }}>
        ...
        <p className="md:px-8 px-12 text-white md:text-sm text-xs uppercase font-thabit " style={{ lineHeight: '26px' }}>UNMANNED UNITED INC.</p>
      ...
      <div className="flex">
        ...
        <div className="md:w-4/5 w-full flex flex-col justify-center px-12 gap-2 items-left border-l border-white border-dashed">
          <p className="text-white text-sm md:text-[16px] font-thabit mt-8 md:mb-0 mb-6 md:mt-0 font-bold">Who We Are</p>
