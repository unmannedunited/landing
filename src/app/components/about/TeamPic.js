...
function TeamPic() {
  ...
  return (
    <div className="relative" >
     ...
     <img src={getImageUrl("/about/about-stamp.png")} className="absolute left-0 top-[-4px]" style={{ transform: `translate3d(${parallax.x}px, 0px, 0)`, willChange: 'transform'}} />
     <img src={getImageUrl("/about/about-stamp.png")} className="absolute left-[35%] top-[-4px]" style={{ transform: `translate3d(${parallax.x}px, 0px, 0)`, willChange: 'transform'}} />
     <img src={getImageUrl("/about/about-stamp.png")} className="absolute left-[70%] top-[-4px]" style={{ transform: `translate3d(${parallax.x}px, 0px, 0)`, willChange: 'transform'}} />
